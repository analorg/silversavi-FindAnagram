...
WORD_TO_USE = 'lask'  # Enter the word that is used for anagrams
...
# Looking for other matching keys (which translate to unique words)
nag_a_rams = find_anagrams(PATH, WORD_LENGTH, WORD_KEY)
